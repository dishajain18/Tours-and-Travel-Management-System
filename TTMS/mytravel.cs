...
namespace TTMS
{
    public partial class mytravel : Form
    {
        ...
        private void mytravel_Load(object sender, EventArgs e)
        {
            ...
            com.Connection = con;
            com.CommandText = "select transaction_id,package_id,tour_name,start_date,end_date from book_tour natural join tour_package where person_id='"+pid+"'";
            com.CommandType = CommandType.Text;
            OracleDataAdapter da = new OracleDataAdapter(com.CommandText, con);
